<div id="accionModalUsuario"
    ...
    <h5 style="margin-bottom: 20px;">¿Qué tarea desea realizar?</h5>
    <div style="text-align: right;">
        <button onclick="editarUsuario()" class="btn btn-sm"
            style="background-color: #4CAF50; color: white; margin-right: 10px;">Editar</button>
        <button onclick="eliminarUsuario()" class="btn btn-sm"
